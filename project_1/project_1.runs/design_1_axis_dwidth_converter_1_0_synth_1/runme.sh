...
HD_PWD='C:/Users/zfsalti/488/AES-Accelerator/project_1/project_1.runs/design_1_axis_dwidth_converter_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_dwidth_converter_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_dwidth_converter_1_0.tcl
